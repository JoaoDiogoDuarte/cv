...
\name{Jo\~{a}o}{Diogo Duarte}
%%% Social
\email{joao@diogoduarte.pt}
\linkedin{joaodduarte97}
%%% Optionals
\position{PhD Student{\enskip\cdotp\enskip}University of Porto and INESC-TEC}
